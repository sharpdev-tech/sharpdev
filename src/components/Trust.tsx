...
const COPY: Record<
  Lang,
  { label: string; lines: [string, string]; accent: string; promises: Promise[] }
> = {
  en: {
    label: "Why people stay",
    lines: ["Six promises,", "in"],
    accent: "writing",
    promises: [
      {
  ...
  sq: {
    label: "Pse njerëzit qëndrojnë",
    lines: ["Gjashtë premtime,", "me"],
    accent: "shkrim",
    promises: [
      {
        title: "Çmim fiks, i rënë dakord që në fillim",
        body: "Merrni një shifër të vetme para se të nisim. Pa faturim me orë, pa fatura që rriten ndërsa prisni.",
      },
      {
        title: "Së pari ju miratoni dizajnin",
        body: "Dizajni i plotë në Figma vjen para zhvillimit. Asgjë nuk publikohet para se të thoni po.",
      },
      {
        title: "Rishikime derisa të jetë si duhet",
        body: "Ndryshoni strukturën, ngjyrat, fjalët. Faza e dizajnit mbaron kur jeni të kënaqur — jo më parë.",
      },
      {
        title: "Shpejtësia është pjesë e ndërtimit",
        body: "Faqet ndërtohen të ngarkohen për rreth një sekondë, në një telefon normal, me një lidhje normale.",
      },
      {
        title: "Gjithçka është e juaja",
        body: "Domeni, strehimi, kodi dhe llogaritë janë në emrin tuaj. Largohuni kur të doni dhe merrni gjithçka me vete.",
      },
      {
        title: "Mund ta përditësoni vetë",
        body: "Aty ku ka kuptim, teksti dhe imazhet ndryshohen pa prekur kod. Jua tregojmë në një telefonatë të shkurtër.",
      },
    ],
  },
};
